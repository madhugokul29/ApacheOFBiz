...
<#escape x as x?html>
  ...
  <#assign jGrowlPosition = Static["org.apache.ofbiz.entity.util.EntityUtilProperties"].getPropertyValue("commonWidget", "widget.jgrowl.position", delegator)>
  <#assign jGrowlWidth = Static["org.apache.ofbiz.entity.util.EntityUtilProperties"].getPropertyValue("commonWidget", "widget.jgrowl.width", delegator)>
  <#assign jGrowlHeight = Static["org.apache.ofbiz.entity.util.EntityUtilProperties"].getPropertyValue("commonWidget", "widget.jgrowl.height", delegator)>
  <#assign jGrowlSpeed = Static["org.apache.ofbiz.entity.util.EntityUtilProperties"].getPropertyValue("commonWidget", "widget.jgrowl.speed", delegator)>
